...
# Ceno Desktop.app Build Script for macOS
# This script builds the Ceno Desktop application specifically
...
echo -e "${BLUE}=== Ceno Desktop.app Build Script for macOS ===${NC}"
...
# Set appropriate configuration file for Ceno Desktop
if [[ "$ARCH" == "arm64" ]]; then
    MOZCONFIG="mozconfig-macos-ceno-desktop"
    echo -e "${GREEN}Using Ceno Desktop configuration for Apple Silicon (ARM64)${NC}"
elif [[ "$ARCH" == "x86_64" ]]; then
    MOZCONFIG="mozconfig-macos-ceno-desktop"
    echo -e "${GREEN}Using Ceno Desktop configuration for Intel (x86_64)${NC}"
else
...
# Set environment variables for Ceno Desktop
...
echo -e "${BLUE}Building: Ceno Desktop.app${NC}"
...
echo -e "${BLUE}Starting Ceno Desktop build process...${NC}"
echo -e "${YELLOW}This may take 1-4 hours depending on your system specifications.${NC}"
echo -e "${BLUE}Target application: Ceno Desktop.app${NC}"

# Start the build
./mach build

echo -e "${GREEN}Ceno Desktop build completed successfully!${NC}"
...
echo -e "   ./mach run"
echo ""
echo -e "${GREEN}2. Create package:${NC}"
echo -e "   ./mach package"
echo ""
echo -e "${GREEN}3. Test Ceno Desktop:${NC}"
echo -e "   ./mach test"
echo ""
echo -e "${BLUE}=== Ceno Desktop.app Build Complete! ===${NC}"